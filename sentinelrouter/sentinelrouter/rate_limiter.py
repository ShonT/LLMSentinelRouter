...
class RateLimitWindow:
    ...
    def _cleanup_expired(self, window: Deque[Tuple[datetime, int]], max_age: timedelta) -> None:
    ...
    async def check_limits(
        ...
        if rpm_limit and usage['requests_last_minute'] >= int(rpm_limit * safety_margin):
