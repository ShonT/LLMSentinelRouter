...
from sentinelrouter.sentinelrouter.semantic_hash import (
    compute_simhash,
    hamming_distance,
)
...
class TestCycleDetector:
    ...
    def test_initialization_custom_threshold(self):
        ...
        detector = CycleDetector(
            session_id="test_session", simhash_threshold=5, window_size=50
        )
    ...
    def test_detect_cycle_exact_duplicate(self):
        ...
        detector = CycleDetector(
            session_id="test_session", simhash_threshold=3, repetition_threshold=1
        )
